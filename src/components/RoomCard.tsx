...
const RoomCard: React.FC<RoomCardProps> = ({ item, index }) => {
  return (
    <div key={index} className="mt-4 h-36 flex justify-between rounded-lg w-96 p-3 border border-gray-400 hover:border-blue-600">
      <div className="bg-transparent">
        <h3 className="h3 cursor-pointer hover:text-blue-600 text-sm text-gray-700 bg-transparent">
