...
const MultipleUsersSvg = () => (
    <svg className="w-5 h-5  md:w-7 md:h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
...
const Bugs = () => (
    <svg className="w-5 h-5  md:w-7 md:h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 19 20">
...
const PlusSvg = () => (
    <svg className="w-5 h-5  md:w-7 md:h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 1v16M1 9h16" />
    </svg>
)

const SearchSvg = () => (
    <svg className="w-5 h-5  md:w-7 md:h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
