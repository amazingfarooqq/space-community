        ...
        <div className="bg-gray-800 py-3">
            <div className="max-w-7xl px-4 mx-auto flex justify-between items-center ">
                ...
                <ThemeSwitch />
                    ...
                    <p className="text-white mr-4">Hello, {session?.data?.user?.name}</p>
                    ...
                    <Link
                        href="/login"
                        className="text-white ml-3 border border-gray-700 hover:bg-gray-700   font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800  dark:text-white dark:hover:bg-gray-700 mr-2"
                    >
                        Sign in
