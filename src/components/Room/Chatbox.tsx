...
const Chatbox = () => {
    ...
    return (
        <>
            <div className="w-1/4 border flex-1 p:2 sm:py-6 sm:px-3 justify-between flex flex-col h-[calc(100vh-2rem)]">
                                ...
                                <div className="flex ">
                                    <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                                        <div>
                                            ...
                                            <div className={`px-4 py-2 rounded-lg inline-block rounded-tl-none ${item % 2 ? "bg-gray-300 text-gray-600" : "bg-blue-600 text-white"} `}>
                                                <h2 className='mb-1'>Farooq dad</h2>
                ...
                <div>
                    {/* <div>sadasdsadhsajd</div> */}
                    <div className="flex">
                        <textarea
                            
                            className="w-full p-2 border rounded-l-lg resize-none"
