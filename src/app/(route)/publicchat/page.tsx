            ...
            <div className=" mx-auto flex justify-between  z-10 ml-16 md:ml-24 px-4 flex-col ">
                ...
                <div className="flex flex-row justify-between w-full">
                    <div className=" w-full  ">
                        <div className='flex shadow-xl dark:shadow-black flex-row justify-between h-[calc(100vh-5rem)] border dark:border-gray-800 flex-1 p:2 sm:px-1 justify-between flex flex-col rounded-lg bg-white dark:bg-[#191D20] '>
